...
|---|---|
| Индивидуальный предприниматель | {client_details} |
...
| БИК 044525974 | |
| | |
| ________________/Шамсутдинов Р.Р. | ________________/{client_signature} |
...
async def download_contract_direct_word(contract_id: str):
    ...
    # Create filename with genitive case
    client_genitive = to_genitive_case(contract_obj.client_name)
    filename_base = f"Договор для {client_genitive}"
