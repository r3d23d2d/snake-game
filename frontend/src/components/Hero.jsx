...
const Hero = ({ data, onOpenForm }) => {
  return (
    <section className="relative bg-gradient-to-br from-cyan-50 via-white to-sky-50 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12 lg:pt-4 lg:pb-32">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-12 items-start lg:items-end h-full min-h-[600px] lg:min-h-[700px]">
          {/* Left content */}
