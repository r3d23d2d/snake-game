        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className="relative animate-fade-in-right delay-400 flex justify-center lg:justify-end">
            <div className="relative group">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-4 -right-4 w-32 h-32 bg-cyan-200/50 rounded-full animate-float"></div>
              <div className="absolute -bottom-4 -left-4 w-28 h-28 bg-sky-300/50 rounded-full animate-float delay-1000"></div>
            </div>
          </div>
        </div>
      </div>
